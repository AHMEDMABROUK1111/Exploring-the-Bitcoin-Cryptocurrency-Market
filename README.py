...
ax.set_title('Top 10 market capitalization', fontsize=20, color='red', weight='bold')
...
# Call the top10_subplot function with volatility7d and the title
